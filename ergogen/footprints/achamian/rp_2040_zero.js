...
`
    function pins(def_neg, def_pos, flip) {
      ...
      return `
        ...
        ${''/* pin labels */}
        (fp_text user P0 (at ${def_pos}5 -10.16)    (layer F.SilkS) ${text_effects})
        (fp_text user P1 (at ${def_pos}5 -7.62)     (layer F.SilkS) ${text_effects})
        (fp_text user P2 (at ${def_pos}5 -5.08)     (layer F.SilkS) ${text_effects})
        (fp_text user P3 (at ${def_pos}5 -2.54)     (layer F.SilkS) ${text_effects})
        (fp_text user P4 (at ${def_pos}5 0)         (layer F.SilkS) ${text_effects})
        (fp_text user P5 (at ${def_pos}5 2.54)      (layer F.SilkS) ${text_effects})
        (fp_text user P6 (at ${def_pos}5 5.08)      (layer F.SilkS) ${text_effects})
        (fp_text user P7 (at ${def_pos}5 7.62)      (layer F.SilkS) ${text_effects})
        (fp_text user P8 (at ${def_pos}5 10.16)     (layer F.SilkS) ${text_effects})

        (fp_text user P9  (at ${def_pos}5.08 8.69)  (layer F.SilkS) ${text_effects})
        (fp_text user P10 (at ${def_pos}2.54 8.69)  (layer F.SilkS) ${text_effects})
        (fp_text user P11 (at 0 8.69)               (layer F.SilkS) ${text_effects})
        (fp_text user P12 (at ${def_neg}2.54 8.69)  (layer F.SilkS) ${text_effects})
        (fp_text user P13 (at ${def_neg}5.08 8.69)  (layer F.SilkS) ${text_effects})

        (fp_text user P14 (at ${def_neg}5 10.16)    (layer F.SilkS) ${text_effects})
        (fp_text user P15 (at ${def_neg}5 7.62)     (layer F.SilkS) ${text_effects})
        (fp_text user P26 (at ${def_neg}5 5.08)     (layer F.SilkS) ${text_effects})
        (fp_text user P27 (at ${def_neg}5 2.54)     (layer F.SilkS) ${text_effects})
        (fp_text user P28 (at ${def_neg}5 0)        (layer F.SilkS) ${text_effects})
        (fp_text user P29 (at ${def_neg}5 -2.54)    (layer F.SilkS) ${text_effects})
        (fp_text user VCC (at ${def_neg}5 -5.08)    (layer F.SilkS) ${text_effects})
        (fp_text user GND (at ${def_neg}5 -7.62)    (layer F.SilkS) ${text_effects})
        (fp_text user 5V  (at ${def_neg}5 -10.16)   (layer F.SilkS) ${text_effects})
